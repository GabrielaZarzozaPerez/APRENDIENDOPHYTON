...
# de residuales. Si el residual es cero, quier decir 
...
# se resuelve por verdadero si al menos una condicion es
# verdadera. Los parentesis le dicen a python que
# las primeras dos condiciones son juntas y la tecera 
# es independiente.
